...
public class PlayerMovementLerp : MonoBehaviour
{
    public Transform player;
     public Transform controllerLeft; 
    public Transform controllerRight;
    public ColorChangerLerpMovement[] balls;
    ...
    private string condition = "MovementManyChoices";
    ...
    private void Start()
    {
        ...
        totalSequences = colorSequences.colorSequences[currentColorSequencesIndex].Length;
    ...
    void ChangeBallColors(int sequenceIndex)
    {
        ...
        if (sequenceIndex >= 0 && sequenceIndex < totalSequences)
        {
